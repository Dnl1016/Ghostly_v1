<?php
    ...
    $color = $controladorColores->buscarColor($_GET['idColor']);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h1>Editar color</h1>
                                <a href="../Controller/controladorColores.php?listarColores" style="height: 50%;" class="btn btn-dark">Regresar</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div id="error"></div>
                            <form action="../Controller/controladorColores.php" method="POST">
                                <input type="hidden" value="<?php echo $color['idColor']; ?>" name="idColor">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombre">Nombre:</label>
                                            <input value="<?php echo $color['nombre']; ?>" required id="nombre" name="nombre" class="form-control" type="text" placeholder="Nombre...">
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="editarColor" type="submit" class="btn btn-dark col-md-12" value="Editar">
                                        <hr>
                                        <a href="../Controller/controladorColores.php?listarColores" class="btn btn-secondary col-md-12">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
