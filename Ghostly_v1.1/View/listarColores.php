<?php
    ...
    $listaColores = $controladorColores->listarColores();
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="../Controller/controladorColores.php?registrarColor" style="height: 50%;" class="btn btn-dark">Nuevo color</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach($listaColores as $color){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="../Controller/controladorColores.php?editarColor=<?php echo $color['idColor'] ?>" class="btn btn-secondary">Editar</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
