                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="../Controller/controladorCategorias.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $categoria['nombre']; ?>" required id="nombre" name="nombre" class="form-control" type="text" placeholder="Nombre...">
                                        </div> 
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input name="editarCategoria" type="submit" class="btn btn-dark col-md-12" value="Editar">
                                        <hr>
                                        <a href="../Controller/controladorCategorias.php?listarCategorias" class="btn btn-secondary col-md-12">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
